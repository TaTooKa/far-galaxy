...
When required to test a **STAT** (<span class="stat">SMARTS, MIGHT, SWIFT, CHARM </span><span>or</span> <span class="stat">GUILE</span>), roll d100 against that value. If equal or under, it’s a <span class="blueish bold">SUCCESS</span>. If over that value, it’s a <span class="reddish bold">FAILURE</span>.
