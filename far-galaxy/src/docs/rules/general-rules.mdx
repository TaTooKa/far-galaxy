...
In **GUIDED** mode, the *GUIDE* decides what happens with everything other than the player characters (NPCs, the environment, etc), and adjudicates the consequences of the player characters’ actions (especially when there is a <span class="reddish bold">FAILURE</span> in their tests).
...
When required to test a **STAT** (<span class="stat">SMARTS, MIGHT, SWIFT, ZEAL </span><span>or</span> <span class="stat">GUILE</span>), roll d100 against that value. If equal or under, it’s a <span class="blueish bold">SUCCESS</span>. If over that value, it’s a <span class="reddish bold">FAILURE</span>.

A match of units and tens is a **CRITICAL** (<span class="blueish bold">SUCCESS</span> or <span class="reddish bold">FAILURE</span>), meaning that the result is greatly exacerbated, for good or ill. On top of that, a 01 is always a <span class="blueish bold">CRITICAL SUCCESS</span> and a 100 is always a <span class="reddish bold">CRITICAL FAILURE</span>.
...
- To keep “the best one” or “the worst one” means that you get to pick the lowest result OR the one that would guarantee a <span class="blueish bold">CRITICAL SUCCESS</span> in the case of a <span class="boost">BOOSTS</span>; and you keep the highest result OR the one that would net you a <span class="reddish bold">CRITICAL FAILURE</span> in the case of a <span class="glitch" data-text="GLITCH">GLITCH</span>.
...
*<span class="blueish bold">IN CONTROL</span>* or *<span class="reddish bold">IN A BAD SPOT</span>*.
...
- <span class="blueish bold">SHORT</span>: Progress by increments of <span class="blueish bold">+30%</span> (it takes 4 progress to maximize chances). It nets 2 XP when fulfilled.
- <span class="blueish bold">MEDIUM</span>: Progress by increments of <span class="blueish bold">+20%</span> (it takes 5 progress to maximize chances). It nets 5 XP when fulfilled.
- <span class="blueish bold">LONG</span>: Progress by increments of <span class="blueish bold">+10%</span> (it takes 10 progress to maximize chances). It nets 10 XP when fulfilled.
- <span class="blueish bold">EXTREME</span>: Progress by increments of <span class="blueish bold">+5%</span> (it takes 20 progress to maximize chances). It nets 20 XP when fulfilled.
- <span class="blueish bold">EPIC</span>: Progress by increments of <span class="blueish bold">+2%</span> (it takes 50 progress to maximize chances). It nets 50 XP when fulfilled.
...
- Set your **GRIT**, **WILL** and **GEAR** to 5.
- Set your three **CHARACTER ARCS** progress to 1.
- Choose your **OBLIGATION** from the options provided. Your **OBLIGATION** is something that regularly puts you in trouble, and that you want to solve before you [RETIRE](/prompts/fate-prompts#retire). You can flesh it out or give it more details in the *OBLIGATION NOTES* section, if you want.
...
## BEGINNING A GAME
- All players involved should envision and/or discuss the era of the *Galaxy Far Away* they'll be playing in.

> The players should create their characters together and decide what they do and why they are together, working as a team.

- Each character has their own objectives, oftentimes enforced by their **OBLIGATION**, and fulfilling it is what each of them should be pursuing (they can decide to directly help each other or not). The **OBLIGATION** works as an *EPIC challenge*, meaning that it will take lots of attempts for each character to progress and eventually fulfill it.  Once all of that’s clear, envision an inciting incident, [ACCEPT A CHALLENGE](/prompts/challenge-prompts#accept-a-challenge) and get to work on it.
<br/>

## ENDING A GAME 
- this game can be played <span class="blueish bold">indefinitely</span> (i.e. you can [RETIRE](/prompts/fate-prompts#retire) a character and continue playing with a new one, but the main plot or the overarching story continues),
- ...or it can be played with <span class="blueish bold">a set destination</span> (i.e. when every character retires or dies, the game is over),
- ...or it can also be played <span class="blueish bold">as a one-shot</span>, in which a single short story plays out and then the game ends.
